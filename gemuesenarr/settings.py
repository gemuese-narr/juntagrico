"""
Django settings for gemuesenarr project.
"""
...
ROOT_URLCONF = 'gemuesenarr.urls'

DATABASES = {
    'default': {
        'ENGINE': os.environ.get('JUNTAGRICO_DATABASE_ENGINE','django.db.backends.sqlite3'), 
        'NAME': os.environ.get('JUNTAGRICO_DATABASE_NAME','gemuesenarr.db'), 
...
WSGI_APPLICATION = 'gemuesenarr.wsgi.application'
...
"""
     juntagrico Settings
"""
ORGANISATION_NAME = "Gemüsenarrr"
ORGANISATION_LONG_NAME = "Gemüsenarrr"
ORGANISATION_ADDRESS = {"name":"Gemüsenarrr", 
            "street" : "Güetlistrasse",
            "number" : "45",
            "zip" : "8132",
            "city" : "Hinteregg",
            "extra" : ""}
